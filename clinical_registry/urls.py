...
from clinical_registry.views import (
    ...
    AnalyticsMolecularChronologyAPIView,
    AnalyticsMolecularSummaryAPIView,
    AnalyticsMolecularResultBreakdownAPIView,
    AnalyticsPatientMatchesAPIView,
...
urlpatterns = [
    ...
    path("analytics/molecular-summary/", AnalyticsMolecularSummaryAPIView.as_view(), name="analytics-molecular-summary"),
    path("analytics/molecular-chronology/", AnalyticsMolecularChronologyAPIView.as_view(), name="analytics-molecular-chronology"),
    path("analytics/molecular-result-breakdown/", AnalyticsMolecularResultBreakdownAPIView.as_view(), name="analytics-molecular-result-breakdown"),
    path("analytics/patients/", AnalyticsPatientMatchesAPIView.as_view(), name="analytics-patients"),
